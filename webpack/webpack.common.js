...
const configFile = {
  ...
  test: fs.readFileSync(path.resolve(__dirname, "../.env.test")),
  staging: fs.readFileSync(path.resolve(__dirname, "../.env.staging")),
